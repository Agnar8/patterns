...
Это структурный паттерн, который позволяет подружить несовместимые объекты.
...
Для меня адаптер, еще когда нужно посунуть модифицированные данные в нужном формате

Содержит логику преобразования и никакую другую